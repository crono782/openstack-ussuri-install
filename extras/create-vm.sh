...
virt-install -n os-network --os-type Linux --os-variant centos7.0 --ram 2048 --vcpus 1 --import --disk /data/images/os-network.qcow2 --network bridge:br0 --network bridge:br4 --network bridge:br4 --graphics vnc --noautoconsole
